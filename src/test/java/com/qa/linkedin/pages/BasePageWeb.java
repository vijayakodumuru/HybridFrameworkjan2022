...
public class BasePageWeb extends TestBase {
	...
	boolean selectOptionCarousel(List<WebElement> element, String option, WebElement nextBtn)throws InterruptedException {
	...
	boolean selectOptionCarouselByAttribute(List<WebElement> element, String option, WebElement nextBtn, String attrib)throws InterruptedException {
